...
module.exports = {
  ...
  EXPLORE_URL: '"http://explorer2.tesra.me:19998/"',
  TEST_EXPLORE_URL: '"http://explorer2.tesra.me:3000/v2/"',

  // 基础API接口
  // API_URL: '"http://localhost:8585/v2"',
  // TEST_API_URL: '"http://localhost:8585/v2"',
  API_URL: '"http://explorer2.tesra.me:3000/v2"',
  TEST_API_URL: '"http://explorer2.tesra.me:3000/v2"',
