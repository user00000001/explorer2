...
import com.github.TesraSupernet.service.BlockHandleService;
...
public class BlockHandlerThread extends Thread {
    ...
    /**
     * initialize tesra TST_SDKSERVICE object for synchronizing data
     */
    private void initSdkService() {
        TstSdk sdkService = TstSdk.getInstance();
        sdkService.setRestful(ConstantParam.MASTERNODE_RESTFULURL);
        ConstantParam.TST_SDKSERVICE = sdkService;
    }
    ...
    private void initConstantParam() {
        ...
        ConstantParam.BATCHBLOCK_TSTID_COUNT = 0;
