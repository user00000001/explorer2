...
public class TxDetail {
    ...
    /**
     * 交易event类型 0:其他 1:部署合约 2:手续费 3:转账 4:TST ID 5:存证 6:权限
     */
    ...
    /**
     * 获取交易event类型 0:其他 1:部署合约 2:手续费 3:转账 4:TST ID 5:存证 6:权限
     *
     * @return event_type - 交易event类型 0:其他 1:部署合约 2:手续费 3:转账 4:TST ID 5:存证 6:权限
     */
    ...
    /**
     * 设置交易event类型 0:其他 1:部署合约 2:手续费 3:转账 4:TST ID 5:存证 6:权限
     *
     * @param eventType 交易event类型 0:其他 1:部署合约 2:手续费 3:转账 4:TST ID 5:存证 6:权限
     */
