...
@tk.mybatis.spring.annotation.MapperScan("com.github.TesraSupernet.mapper")
public class TstsynchandlerApplication {
...
/*		executor.setRejectedExecutionHandler(new RejectedExecutionHandler() {
    ...
    public static void main(String[] args) {
        SpringApplication.run(TstsynchandlerApplication.class, args);
    }
}
