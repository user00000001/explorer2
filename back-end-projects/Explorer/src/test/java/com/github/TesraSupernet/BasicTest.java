...
/*        String contractAddress = Address.parse(com.github.TesraSupernet.common.Helper.reverse("8c15299cc6843e808b42f1ffb9cff7ec36f81ea1")).toBase58();
        ...
        BigDecimal tsgreward = new BigDecimal("19841").divide(new BigDecimal("5"), 2, ROUND_HALF_DOWN).multiply(temp);
        System.out.println("tsgreward:" + tsgreward);
...
/*        if (com.github.TesraSupernet.util.Helper.isNotEmptyAndNull(result)) {
        ...
        if (com.github.TesraSupernet.util.Helper.isNotEmptyAndNull(result)) {
            ...
            System.out.println("tst_id:"+new String(Helper.hexToBytes((String) map.get("tstid"))));
        }
    }
