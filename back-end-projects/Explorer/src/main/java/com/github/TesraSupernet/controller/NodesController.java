...
import com.github.TesraSupernet.service.impl.ConfigServiceImpl;
import com.github.TesraSupernet.service.impl.NodesServiceImpl;
import com.github.TesraSupernet.service.impl.TstSdkServiceImpl;
...
public class NodesController {
    ...
    private final TstSdkServiceImpl tstSdkService;

    @Autowired
    public NodesController(NodesServiceImpl nodesService,
                           ConfigServiceImpl configService,
                           TstSdkServiceImpl tstSdkService) {
    ...
    public ResponseBean getCurrentStakingCycle() {
        int currentStakingView = tstSdkService.getGovernanceView();
    ...
    @ApiOperation(value = "Get total TST stakes and percentage total TST stakes of total supply")
    ...
    @ApiOperation(value = "Get reward per 10000 TST stake unit")
    ...
    @ApiOperation(value = "Get latest reward per 10000 TST stake unit by public key")
